...
public class ContainerFancyChest extends Container{
	protected TileFancy tile_entity;
       
	public ContainerFancyChest(TileFancy tile_entity, InventoryPlayer player_inventory){
